...
export const themes: Record<string, ThemeColors> = {
  ...
  'crystal-prism': {
    ...
    id: 'crystal-prism',
    uBaseColor1: new THREE.Color(0.01, 0.02, 0.04),
    uBaseColor2: new THREE.Color(0.02, 0.04, 0.08),
    uCoolCore: new THREE.Color(0.4, 0.9, 1.0),   // Icy cyan
    uCoolEdge: new THREE.Color(0.7, 0.7, 1.0),    // Soft blue-white
    uWarmCore: new THREE.Color(1.0, 0.6, 0.9),    // Pink crystal
    uWarmEdge: new THREE.Color(0.8, 1.0, 1.0),    // Aqua prism
    uRippleColor: new THREE.Color(1.0, 1.0, 1.0), // Pure white flash
    uGlowIntensity: 2.2,
  },
  ...
  'crystal-prism': {
    name: '水晶棱镜',
    id: 'crystal-prism',
    uBaseColor1: new THREE.Color(0.02, 0.03, 0.05),
    uBaseColor2: new THREE.Color(0.03, 0.05, 0.09),
    uCoolCore: new THREE.Color(0.35, 0.75, 0.95),   // Soft icy blue
    uCoolEdge: new THREE.Color(0.55, 0.55, 0.85),    // Muted lavender
    uWarmCore: new THREE.Color(0.85, 0.5, 0.7),      // Soft rose
    uWarmEdge: new THREE.Color(0.5, 0.85, 0.9),      // Pale aqua
    uRippleColor: new THREE.Color(0.9, 0.95, 1.0),   // Soft white
    uGlowIntensity: 1.6,
  },
};